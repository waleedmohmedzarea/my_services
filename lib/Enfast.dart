...
import 'Twasol.dart';
import 'Wasta.dart';
class Enfast extends StatefulWidget {
  const Enfast({Key? key}) : super(key: key);

  @override
  _EnfastState createState() => _EnfastState();
}

class _EnfastState extends State<Enfast> {
  @override
