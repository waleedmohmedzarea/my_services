...
import 'Twasol.dart';
import 'Wasta.dart';
 class Kman extends StatefulWidget {
   const Kman({Key? key}) : super(key: key);

   @override
   _KmanState createState() => _KmanState();
 }

 class _KmanState extends State<Kman> {
   @override
