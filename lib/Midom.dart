...
import 'Twasol.dart';
import 'Wasta.dart';
class Midom extends StatefulWidget {
  const Midom({Key? key}) : super(key: key);

  @override
  _MidomState createState() => _MidomState();
}

class _MidomState extends State<Midom> {
  @override
