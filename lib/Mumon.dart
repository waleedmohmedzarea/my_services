...
import 'Twasol.dart';
import 'Wasta.dart';
class Mumon extends StatefulWidget {
  const Mumon({Key? key}) : super(key: key);

  @override
  _MumonState createState() => _MumonState();
}

class _MumonState extends State<Mumon> {
  @override
...
//قمن العروس
      ...
      appBar: AppBar(
        ...
        title: const Text(
          "الخدمات المتاحة في قرية الميمون",
          style: TextStyle(
              color: Colors.black,
              fontSize: 16,
              fontFamily: "Cairo",
