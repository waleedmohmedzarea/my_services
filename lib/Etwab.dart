...
import 'Twasol.dart';
import 'Wasta.dart';
class Etwab extends StatefulWidget {
  const Etwab({Key? key}) : super(key: key);

  @override
  _EtwabState createState() => _EtwabState();
}

class _EtwabState extends State<Etwab> {
  @override
