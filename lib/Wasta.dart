...
import 'Srs.dart';
import 'Twasol.dart';
class Wasta extends StatefulWidget {
  const Wasta({Key? key}) : super(key: key);

  @override
  _WastaState createState() => _WastaState();
}

class _WastaState extends State<Wasta> {
  @override
...
//قمن العروس
      ...
      appBar: AppBar(
        ...
        title: const Text(
          "الخدمات المتاحةفي مدينة الواسطي",
          style: TextStyle(
              color: Colors.black,
              fontSize: 16,
              fontFamily: "Cairo",
